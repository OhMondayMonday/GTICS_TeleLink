...
public class EmailService {
    ...
    public void sendAssistanceNotification(Usuario coordinador, Asistencia asistencia) throws MessagingException {
        ...
        String establecimientoNombre = asistencia.getEspacioDeportivo().getEstablecimientoDeportivo()
    ...
    public void sendReservationConfirmation(Usuario usuario, Reserva reserva) throws MessagingException {
        ...
        String establecimientoNombre = reserva.getEspacioDeportivo().getEstablecimientoDeportivo()
                .getEstablecimientoDeportivoNombre();
     ...
     */
    public void sendAssistanceCancellation(Usuario coordinador, Asistencia asistencia, String motivo)
    ...
    public void sendReservationCancelled(Usuario usuario, Reserva reserva, String razonCancelacion)
            throws MessagingException {
        ...
        String content = """
                ...
                """
                .formatted(usuario.getNombres(), formattedFecha, formattedInicio, formattedFin,
                        espacioNombre, tipoDeporte, establecimientoNombre,
                        razonCancelacion != null ? razonCancelacion : "No especificada",
                        java.time.Year.now().getValue());
    ...
    // ...existing code...
    public void sendReservationPaymentCompleted(Usuario usuario, Reserva reserva, BigDecimal montoPageado)
            throws MessagingException {
        ...
        // Configurar información específica según el tipo de deporte
        String detallesEspecificos = "";
        String tipoDeporteNormalizado = tipoDeporte.toLowerCase();

        if (tipoDeporteNormalizado.contains("piscina") || tipoDeporteNormalizado.contains("natación")) {
            detallesEspecificos = String.format("""
                    <p><strong>🏊‍♂️ Carril de Piscina:</strong> %s</p>
                    <p><strong>👥 Número de Participantes:</strong> %d</p>
                    """,
                    reserva.getNumeroCarrilPiscina() != null ? "Carril " + reserva.getNumeroCarrilPiscina()
                            : "No asignado",
                    reserva.numeroParticipantes() != null ? reserva.numeroParticipantes() : 1);
        } else if (tipoDeporteNormalizado.contains("atletismo") || tipoDeporteNormalizado.contains("pista")) {
            detallesEspecificos = String.format("""
                    <p><strong>🏃‍♂️ Carril de Pista:</strong> %s</p>
                    <p><strong>👥 Número de Participantes:</strong> %d</p>
                    """,
                    reserva.getNumeroCarrilPista() != null ? "Carril " + reserva.getNumeroCarrilPista() : "No asignado",
                    reserva.numeroParticipantes() != null ? reserva.numeroParticipantes() : 1);
        } else if (tipoDeporteNormalizado.contains("gimnasio") || tipoDeporteNormalizado.contains("gym")) {
            detallesEspecificos = String.format("""
                    <p><strong>👥 Número de Participantes:</strong> %d</p>
                    """,
                    reserva.numeroParticipantes() != null ? reserva.numeroParticipantes() : 1);
        } else {
            // Para otros tipos de deportes, solo mostrar participantes si es mayor a 1
            if (reserva.numeroParticipantes() != null && reserva.numeroParticipantes() > 1) {
                detallesEspecificos = String.format("""
                        <p><strong>👥 Número de Participantes:</strong> %d</p>
                        """, reserva.numeroParticipantes());
            }
        }
        ...
        String content = """
                ...
                """
                .formatted(usuario.getNombres(), formattedFecha, formattedInicio, formattedFin,
                        espacioNombre, tipoDeporte, establecimientoNombre, detallesEspecificos, duracionHoras,
                        montoPageado.toString(), LocalDate.now().format(dateFormatter),
                        java.time.Year.now().getValue());

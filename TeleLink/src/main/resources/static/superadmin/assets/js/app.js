!function (n) {
    ...
    if (n("#side-menu").metisMenu(), n("#vertical-menu-btn").on("click", function (e) {
        e.preventDefault(), n("body").toggleClass("sidebar-enable"), 992 <= n(window).width() ? n("body").toggleClass("vertical-collpsed vertical-expanded") : n("body").removeClass("vertical-collpsed vertical-expanded")
        ...
        $(document).on("click", "body", function (e) {
            // Verifica si el clic NO fue dentro de la topbar ni el menú vertical
            if (
                $(e.target).closest("#page-topbar, .vertical-menu").length === 0 &&
                $("body").hasClass("vertical-expanded")
            ) {
                $("body").toggleClass("vertical-collpsed");
                $("body").removeClass("vertical-expanded");
            }
        });
